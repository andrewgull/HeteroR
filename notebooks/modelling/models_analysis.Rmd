...
ggsave(file="manuscript/images/Fig_9A_best_ROCs.png", plot=Fig_9A, width = 8, height=4, units = "in")
...
ggsave(file="manuscript/images/Fig_9B_posterior.png", plot=Fig_9B, width = 8, height=4, units = "in")
...
ggsave(file="manuscript/images/Fig_9AB.png", plot=Fig_9AB, width = 8, height=4, units = "in")
...
ggsave(file="manuscript/images/Fig_9C_prob_cutoff.png", plot=Fig_9C, width = 8, height=4, units = "in")
...
ggsave(file="manuscript/images/Fig_9D_predictors.png", plot=Fig_9D, width = 8, height=10, units = "in")
...
Fig_9D_alt <-
  lr_coeff_df %>%
  mutate(
    effect = if_else(estimate < 0, "increase HR prob.", "decrease HR prob."),
    odds.ratio_ = if_else(odds.ratio < 1.0, odds.ratio * (-1), odds.ratio)
  ) %>%
  filter(term != "(Intercept)", term != "n.beta.lac") %>%
  ggplot(aes(reorder(term, odds.ratio, decreasing = T), odds.ratio_)) +
  geom_col(aes(fill = effect)) +
  #scale_color_brewer(palette = "Paired", guide = guide_legend(title = NULL)) +
...
ggsave(file="manuscript/images/Fig_9D_alt_predictors.png", plot=Fig_9D_alt, width = 8, height=6, units = "in")
...
ggsave(file="manuscript/images/Fig_9CD.png", plot=Fig_9CD, width = 8, height=11, units = "in")
