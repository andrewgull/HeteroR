...
### KR and GBT prob cutoff together
...
Fig_LR_prob_cutoff_predictors <- ggarrange(Fig_LR_prob_cutoff, Fig_LR_predictors_alt,
                    labels = c("C", "D"),
                    ncol = 1, nrow = 2)

ggsave(file="manuscript/images/Fig_prob_cutoff_predictors.png", plot=Fig_LR_prob_cutoff_predictors, width = 8, height=11, units = "in")

Fig_LR_prob_cutoff_predictors
```
