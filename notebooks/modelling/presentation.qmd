...
(more on Pip/Tazo and mechanisms)
...
## How many RG were found? (1) {.smaller}
...
A model predicting only nonHR will have 81/393 = 80% accuracy

Solution: 

SMOTE - Synthetic Minority Oversampling Technique

SMOTE creates artificial data points along the vectors connecting the real data points in high dimensional feature space

SMOTE increases false positives and decreases false negatives 
...
- Random forest (RF)
- Multilayer perceptron/feed-forward neural network (MLP)
- eXtreme Gradient Boosted Trees (XGB)
- Stack of models

each with all predictors, non-correlated predictors and PCs as predictors
::: 

## Model performance

::: incremental
- ROC (how well a model tells the classes apart)
- gain curve (how well a model finds HR strains)
- mean AUC (over 100 resamples)
- difference of mean AUCs (Bayesian ANOVA)
:::
...
Simple LR is the best (after data set update), XGB is the second

## Predictors importance

![Features importance]()

## Test set (the unseen data)

ROC, AUC, CM; prob threshold
...
- More data!
- Better data (better coverage, better assemblies, better gene detection, better repeat count)
- More biologically relevant predictors

## Warnings

- Source of data (hospitals in Uppsala)
- HR definition (groups 1, 2, 3, 5, 4...) HR-index?
- Data set size
