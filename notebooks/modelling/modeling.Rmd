...
# TWO CLASSIFICATION SCHEMES IN FILES
...
```{r, fig.width=12}
nnet_ncorr_bres <- readRDS(paste0(models_path, "mlpb_nnet_ncorr_i50_rs20.rds"))
...
```{r, fig.width=8, fig.height=6}
roc_selected_df <- map2_dfr(list(lr_ncorr_res, nnet_ncorr_bres, xgb_ncorr_bres_long, rf_ncorr_bres),
                            c("LR", "MLP b", "XGB", "RF"), 
                            function(x, y) make_roc(x, y))
