...
```{r, fig.width=10}
lr_ncorr_res <- readRDS(paste0(models_path, "lr_ncorr_rs200.rds"))
...
## NCORR recipe + space-filling (nnet)

200 random starting points

```{r, fig.width=12}
nnet_ncorr_res <- readRDS(paste0(models_path, "mlpn_ncorr_rs200_it50.rds"))
...
```{r, fig.width=8, fig.height=6}
roc_selected_df <- map2_dfr(list(lr_ncorr_res, xgb_ncorr_bres, nnet_ncorr_res),
                            c("LR no corr", "BT no corr", "MLP no corr"), 
