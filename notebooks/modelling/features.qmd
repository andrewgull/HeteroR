...
rgi <- map_dfr(strains, function(x){
        read_delim(paste0("/home/andrei/Data/HeteroR/results/resistance_genes/", x, "/rgi_table.txt"), na = c("n/a", ""), name_repair = "universal") %>% 
          mutate(strain = x)}) %>% 
...
I've decided to add `coverage` and `max_len` to features. This data comes from coverage statistics.
