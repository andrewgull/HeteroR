...
```{r constants}
annot_dir <- "HeteroR/results/annotations/"
rep_bed_dir <- "HeteroR/results/direct_repeats/"
res_genes_dir <- "HeteroR/results/resistance_genes/"
ass_joined_path <- "HeteroR/results/assemblies_joined/"
coverage_dir <- "HeteroR/results/genome_coverage/"
isescan_dir <- "HeteroR/results/isescan/"
# this table will be compiled later (see the lines 493-500)
coverage_table <- "results/coverage/strains_coverage.tsv"
```
...
```{bash}
# run this script inside ./HeteroR
workflow/scripts/coverage_cli.py configs/strains_main.txt 5131220 results/coverage/strains_coverage.tsv filtered
```
