...
These beta-lactamases are targets for tazobactam which inhibits their activity.
It makes sense to add types of TEM and SHV as separate features to `features_strain`
