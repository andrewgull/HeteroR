...
final_tibble <- tibble(Model = character(0), 
...
new_model_row <- function(model_results,model_name,preprocessing_name){ 
...
models_except_LLR = c("lSVM", "pSVM", "rbfSVM", "MLP_nnet", "BAG_MLP", "MARS", "BAG_MARS", "KNN", "RF", "BT","BT_bres")
...
return(tibble(Model = model_name, Preprocessing= preprocessing_name, mean_AUC = mean_auc, AUC_SE = AUC_SE, mean_j_index = mean_j_index, j_index_SE=j_index_SE, Correlation = corr_tune, n_predictors =  n_predictors))
}


## BASE

final_tibble <- bind_rows(final_tibble,new_model_row(models_llr$result[[1]],"LR", "BASE"))

## baseyj_LLR

final_tibble <- bind_rows(final_tibble,new_model_row(models_llr$result[[2]],"LR", "BASE_yj"))

## baseorq_LLR

final_tibble <- bind_rows(final_tibble,new_model_row(models_llr$result[[3]],"LR", "BASE_orq"))

## PCA LLR

final_tibble <- bind_rows(final_tibble,new_model_row(models_llr$result[[4]],"LR", "PCA"))
...
final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[1]],"lSVM", "NCORR"))


## ncorryj_lsvm

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[6]],"lSVM", "NCORR_YJ"))

## ncorrorq_lsvm

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[11]],"lSVM", "NCORRORQ"))


## pca_lsvm 

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[16]],"lSVM", "PCA"))

# pSVM 

## ncorr_psvm 

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[2]],"pSVM", "NCORR"))

## ncorryj_psvm

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[7]],"pSVM", "NCORR_YJ"))

## ncorrorq_psvm

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[12]],"pSVM", "NCORRORQ"))

## pca_psvm

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[17]],"pSVM", "PCA"))
...
final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[3]],"rbfSVM", "NCORR"))

## ncorryj_psvm

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[8]],"rbfSVM", "NCORR_YJ"))

## ncorrorq_psvm

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[13]],"rbfSVM", "NCORRORQ"))

## pca_psvm

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[18]],"rbfSVM", "PCA"))
...
final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[4]],"MLP_nnet", "NCORR"))


## ncorryj_mlp_nnet

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[9]],"MLP_nnet", "NCORR_YJ"))

## ncorrorq_mlp_nnet

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[14]],"MLP_nnet", "NCORRORQ"))

## pca_mlp_nnet 

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[19]],"MLP_nnet", "PCA"))

# BAG_MLP

## ncorr_bag_mlp 

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[5]],"BAG_MLP", "NCORR"))

## ncorryj_bag_mlp

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[10]],"BAG_MLP", "NCORR_YJ"))

## ncorrorq_bag_mlp

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[15]],"BAG_MLP", "NCORRORQ"))

## pca_bag_mlp 

final_tibble <- bind_rows(final_tibble,new_model_row(models_svm_mlp$result[[20]],"BAG_MLP", "PCA"))
...
final_tibble <- bind_rows(final_tibble,new_model_row(models_mars_knn$result[[1]],"MARS", "NCORR"))

## ncorryj_mars

final_tibble <- bind_rows(final_tibble,new_model_row(models_mars_knn$result[[4]],"MARS", "NCORR_YJ"))

## ncorrorq_mars

final_tibble <- bind_rows(final_tibble,new_model_row(models_mars_knn$result[[7]],"MARS", "NCORRORQ"))

## pca_mars 

final_tibble <- bind_rows(final_tibble,new_model_row(models_mars_knn$result[[10]],"MARS", "PCA"))

# BAG MARS

## ncorr_bag_mars 

final_tibble <- bind_rows(final_tibble,new_model_row(models_mars_knn$result[[3]],"BAG_MARS", "NCORR"))

## ncorryj_bag_mars

final_tibble <- bind_rows(final_tibble,new_model_row(models_mars_knn$result[[6]],"BAG_MARS", "NCORR_YJ"))

## ncorrorq_bag_mars

final_tibble <- bind_rows(final_tibble,new_model_row(models_mars_knn$result[[9]],"BAG_MARS", "NCORRORQ"))

## pca_bag_mars 

final_tibble <- bind_rows(final_tibble,new_model_row(models_mars_knn$result[[12]],"BAG_MARS", "PCA"))

# KNN 

## ncorr_knn

final_tibble <- bind_rows(final_tibble,new_model_row(models_mars_knn$result[[2]],"KNN", "NCORR"))

## ncorryj_knn

final_tibble <- bind_rows(final_tibble,new_model_row(models_mars_knn$result[[5]],"KNN", "NCORR_YJ"))

## ncorrorq_knn

final_tibble <- bind_rows(final_tibble,new_model_row(models_mars_knn$result[[8]],"KNN", "NCORRORQ"))

## pca_knn

final_tibble <- bind_rows(final_tibble,new_model_row(models_mars_knn$result[[11]],"KNN", "PCA"))
...
final_tibble <- bind_rows(final_tibble,new_model_row(models_rf_bt$result[[1]],"RF", "BASE"))


## base_boruta_rf 

final_tibble <- bind_rows(final_tibble,new_model_row(models_rf_bt$result[[3]],"RF", "BASE_BORUTA"))

# BT

## base_bt

final_tibble <- bind_rows(final_tibble,new_model_row(models_rf_bt$result[[2]],"BT", "BASE"))

## base_bt_bres
base_bt_bres <- readRDS("/mnt/data/andrei/Data/HeteroR/results/models/scheme12/base_bt_bres_light.rds")

final_tibble <- bind_rows(final_tibble,new_model_row(base_bt_bres,"BT_bres", "BASE"))


## base_boruta_bt 

final_tibble <- bind_rows(final_tibble,new_model_row(models_rf_bt$result[[4]],"BT", "BASE_BORUTA"))


## base_boruta_bt_bres
bt_base_boruta_bres <- readRDS("/mnt/data/andrei/Data/HeteroR/results/models/scheme12/base_bt_boruta_bres_light.rds")

final_tibble <- bind_rows(final_tibble,new_model_row(bt_base_boruta_bres,"BT_bres", "BASE_BORUTA"))
