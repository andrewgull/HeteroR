...
final_tibble <- tibble(Model = "LR", Preprocessing= "BASE", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = NA, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "LR", Preprocessing= "BASE_yj", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "LR", Preprocessing= "BASE_orq", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "LR", Preprocessing= "PCA", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "lSVM", Preprocessing= "NCORR", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "lSVM", Preprocessing= "NCORR_YJ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "lSVM", Preprocessing= "NCORRORQ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "lSVM", Preprocessing= "PCA", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "pSVM", Preprocessing= "NCORR", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "pSVM", Preprocessing= "NCORR_YJ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "pSVM", Preprocessing= "NCORRORQ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "pSVM", Preprocessing= "PCA", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "rbfSVM", Preprocessing= "NCORR", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "rbfSVM", Preprocessing= "NCORR_YJ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "rbfSVM", Preprocessing= "NCORRORQ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "rbfSVM", Preprocessing= "PCA", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "MLP_nnet", Preprocessing= "NCORR", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "MLP_nnet", Preprocessing= "NCORR_YJ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "MLP_nnet", Preprocessing= "NCORRORQ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "MLP_nnet", Preprocessing= "PCA", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "BAG_MLP", Preprocessing= "NCORR", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "BAG_MLP", Preprocessing= "NCORR_YJ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "BAG_MLP", Preprocessing= "NCORRORQ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "BAG_MLP", Preprocessing= "PCA", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "MARS", Preprocessing= "NCORR", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "MARS", Preprocessing= "NCORR_YJ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "MARS", Preprocessing= "NCORRORQ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "MARS", Preprocessing= "PCA", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "BAG_MARS", Preprocessing= "NCORR", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "BAG_MARS", Preprocessing= "NCORR_YJ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "BAG_MARS", Preprocessing= "NCORRORQ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "BAG_MARS", Preprocessing= "PCA", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "KNN", Preprocessing= "NCORR", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "KNN", Preprocessing= "NCORR_YJ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "KNN", Preprocessing= "NCORRORQ", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "KNN", Preprocessing= "PCA", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "RF", Preprocessing= "BASE", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "RF", Preprocessing= "BASE_BORUTA", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "BT", Preprocessing= "BASE", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "BT_bres", Preprocessing= "BASE", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "BT", Preprocessing= "BASE_BORUTA", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
...
tmp_tibble <- tibble(Model = "BT_bres", Preprocessing= "BASE_BORUTA", mean_AUC = mean_auc, st_error = st_error, mean_j_index = mean_j_index, Correlation = corr_tune, n_predictors =  n_predictors)
