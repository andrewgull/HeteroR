...
```{r}
mars_rocs <- map2_dfr(list(mars_ncorr_res, mars_ncoryj_res, mars_ncorq_res, mars_yjmainrfe_race, bagmars_yjmainrfe_race), c("ncorr sfg", "ncorr.yj sfg","ncorrq sfg","mainrfe.yj race","bag mainrfe.yj race"), 
                            function(x, y) make_roc(x, y))
...
```{r}
mars_comp <- res_comp_table(res_list = list(mars_ncorr_res, mars_ncoryj_res, mars_ncorq_res, mars_yjmainrfe_race, bagmars_yjmainrfe_race),
                            mod_names = c("ncorr sfg", "ncorr.yj sfg","ncorrq sfg","mainrfe.yj race","bag mainrfe.yj race"))
...
```{r}
lsvm_comp <- res_comp_table(res_list = list(lsvm_ncorr_res, lsvm_ncoryj_res, lsvm_ncorq_res, lsvm_yjmainrfe_race, lsvm_yjmainrfe_bayes),
...
psvm_rocs <- map2_dfr(list(psvm_ncorr_res, psvm_ncorq_res, psvm_ncoryj_res, psvm_pca_res, psvm_yjmainrfe_race, psvm_yjmainrfe_bayes),
                            c("ncorr", "ncorq", "ncorr.yj", "pca.yj", "ref+yj race", "ref+yj bayes"), 
                            function(x, y) make_roc(x, y))
...
```{r}
psvm_comp <- res_comp_table(res_list = list(psvm_ncorr_res, psvm_ncorq_res, psvm_ncoryj_res, psvm_pca_res, psvm_yjmainrfe_race, psvm_yjmainrfe_bayes),
                            mod_names = c("ncorr", "ncorq", "ncorr.yj", "pca.yj", "ref+yj race", "ref+yj bayes"))
...
```{r, fig.height=3, fig.width=6}
rbf_rocs <- map2_dfr(list(rbf_main_res, rbf_ncorr_res, rbf_ncorq_res, rbf_ncoryj_res, rbfsvm_yjmainrfe_race, rbfsvm_yjmainrfe_bayes ),
                            c("main", "ncorr", "ncorr.orq", "ncorr.yj", "rfe+yj race", "rfe+yj bayes"), 
                            function(x, y) make_roc(x, y))
...
```{r, fig.height=2, fig.width=5}
rbf_comp <- res_comp_table(res_list = list(rbf_main_res, rbf_ncorr_res, rbf_ncorq_res, rbf_ncoryj_res, rbfsvm_yjmainrfe_race, rbfsvm_yjmainrfe_bayes),
                            mod_names = c("main", "ncorr", "ncorr.orq", "ncorr.yj", "rfe+yj race", "rfe+yj bayes"))
...
```{r, fig.height=3, fig.width=6}
knn_rocs <- map2_dfr(list(knn_ncorr_res, knn_ncorq_res, knn_ncoryj_res, knn_yjmainrfe_race),
                            c("ncorr", "ncorr.orq", "ncorr.yj","rfe.yj race" ), 
                            function(x, y) make_roc(x, y))
...
```{r}
knn_rocs <- map2_dfr(list(knn_ncorr_res, knn_ncorq_res, knn_ncoryj_res, knn_yjmainrfe_race), c("ncorr", "ncorr.orq", "ncorr.yj", "rfe race.yj"), 
                            function(x, y) make_roc(x, y))
...
```{r, fig.width=5, fig.height=2}
rf_comp <- res_comp_table(res_list = list(rf_main_res, rf_ncorr_res, rf_ncoryj_res, rf_mainrfe_race),
                          mod_names = c("main", "ncorr", "ncorr.yj", "rfe race"))
...
```{r, fig.width=6, fig.height=3}
xgb_rocs <- map2_dfr(list(xgb_main_res, xgb_ncorr_bres, xgb_ncorr_wl, xgb_ncoryj_res, xgb_mainrfe_race,xgb_mainrfe_bayes),
                            c("XGB main",  "XGB ncorr b", "XGB ncorr wl", "XGB ncorr yj", "XGB rfe race", "XGB rfe bayes"), 
                            function(x, y) make_roc(x, y))
...
xgb_comp <-
  res_comp_table(
    res_list = list(xgb_main_res, xgb_ncorr_bres, xgb_ncorr_wl, xgb_ncoryj_res, xgb_mainrfe_race,xgb_mainrfe_bayes),
    mod_names = c("XGB main",  "XGB ncorr b", "XGB ncorr wl", "XGB ncorr yj", "XGB rfe race", "XGB rfe bayes")
  )
