...
Let's take a rule 'if there is more than 3 beta-lactamases, then the strain is HR' (from EDA)
...
## Boruta features selection + main recipe + Bayes search

```{r}
xgb_main_bor_bres <- readRDS(paste0(models_path, "bt_mainbor_bres_bs_p30.rds"))
...
summary(xgb_preproc_diff) %>% filter(grepl("bor.", contrast))
```
