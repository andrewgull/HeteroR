...
```{r}
lr_rocs <- map2_dfr(list(lr_ncorr_res, lr_ncoryj_res, lr_pcayj_res, lr0_ncoryj_res),
                            c("LR ncorr",  "LR ncorr+yj", "LR pca+yj", "LR ridge ncor+yj"), 
...
lr_comp <-
  res_comp_table(
    res_list = list(lr_ncorr_res, lr_ncoryj_res, lr_pcayj_res, lr0_ncoryj_res),
    mod_names = c("ncorr", "ncorr.yj", "pca.yj", "ridge")
  )
