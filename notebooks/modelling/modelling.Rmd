...
```{r, fig.width=5, fig.height=2}
mlp_rocs <- map2_dfr(list(mlp_ncoryj, mlp_pca, mlp_ncorq),
                            c("MLP ncorr+yj",  "MLP pca+yj", "MLP ncorq"), 
                            function(x, y) make_roc(x, y))
...
```{r}
mlp_comp <- res_comp_table(res_list = list(mlp_ncoryj, mlp_pca, mlp_ncorq),
                           mod_names = c("ncoryj", "pca", "ncorq"))
