...
```{r}
mod_comparison <- res_comp_table(list(lr_ncoryj_res, rf_min_res),
                                 c("LR", "RF"))
...
As XGB with Boruta-selected predictors, this one lacks high sensitivity.
