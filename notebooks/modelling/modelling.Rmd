...
saveRDS(rf_min_res, "/home/andrei/Data/HeteroR/results/models/scheme12/rf_min3_res.rds")
...
```{r}
xgb_min3_bres <- readRDS("~/Data/HeteroR/results/models/scheme12/xgb_min3_yj_bres_p30.rds")
...
roc_min_df %>% 
  ...
  coord_equal() + 
  #scale_color_viridis_d(direction = -1, option = "H")+
  scale_color_brewer(palette = "Set1") +0.8936514
  ggtitle("")
```
