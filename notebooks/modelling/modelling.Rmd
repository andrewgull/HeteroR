...
```{r}
mlpnne_yjmainrfe_race <- readRDS(paste0(models_path, "mlpnnet_yjmainrfe_race_p30.rds"))

plot_race(mlpnne_yjmainrfe_race)
```
### The best ones

```{r}
show_best(mlpnne_yjmainrfe_race)
```
### ROC

```{r}
make_roc(mlpnne_yjmainrfe_race, "") %>% 
  autoplot() + ggtitle("knn (rfe + YJ)")
```
