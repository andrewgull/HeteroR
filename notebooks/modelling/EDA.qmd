...
#### nonHR strains in HR cluster

In this small red cluster of HRs, two strains are nonHR. Find their names.

```{r}
umap_sup_yj_recipe %>%
  prep() %>% juice() %>% 
  select(UMAP02, UMAP04, strain, resistance) %>% 
  filter(UMAP02 > 0.5, UMAP04 < 0, resistance == "nonHR")
```
...
## All dimensionality reduction lots

```{r,fig.height=10, fig.width=10}
Fig_dim_red_all <- ggarrange(Fig_PCA, Fig_kPCA, Fig_UMAPu, Fig_UMAPs,
                    labels = c("A", "B", "C", "D"),
                    ncol = 2, nrow = 2, common.legend = TRUE)

ggsave(file="manuscript/images/Fig_dimred_all.png", plot=Fig_dim_red_all, width = 8, height=8, units = "in")
...
```{r}
Fig_BL_greater_4 <- ggplot(data_strain, aes(n.beta.lac.4)) +
  geom_bar(aes(fill = resistance), position = "fill", alpha=0.8) +
  scale_fill_brewer(palette="Set1") +
  xlab("n β-lactamases") +
  ylab("proportion of strains") +
...
ggsave(file="manuscript/images/Fig_BL_greater_4.png", plot=Fig_BL_greater_4, width = 8, height=4, units = "in")
...
Fig_TEM <- ggplot(data_strain, aes(TEM.beta.lactamase)) +
  ...
  xlab("TEM β-lactamases") +
  ylab("proportion of strains")

ggsave(file="manuscript/images/Fig_TEM.png", plot=Fig_TEM, width = 8, height=4, units = "in")
...
ggsave(file="manuscript/images/Fig_BL_TEM.png", 
       plot=Fig_BL_TEM, width = 8, height=8, units = "in")
...
```{r}
Fig_4 <- ggarrange(Fig_4A , Fig_4B + ylab("") ,
                    labels = c("A", "B"),
                    ncol = 2, nrow = 1, common.legend = TRUE,legend = "bottom")

ggsave(file="manuscript/images/Fig_4_BL4+TEM.png", plot=Fig_4, width = 8, height=4, units = "in")
...
ggsave(file="manuscript/images/Fig_coverage.png", plot=Fig_coverage, width = 8, height=4, units = "in")
...
Fig_nanopore <- ggarrange(Fig_coverage, Fig_longest_read, 
          labels = c("A", "B"),
                    ncol = 1, nrow = 2)

ggsave(file="manuscript/images/Fig_coverage_read_length.png", plot=Fig_nanopore, width = 8, height=8, units = "in")
...
Fig_AR_len <- ar_len %>% 
  ...
  geom_jitter(alpha = 0.2, width = 0.05, height = 0.1, size = 0.8) +
  scale_fill_brewer(palette = "Pastel1") +
  scale_y_continuous(labels = label_log(base=10), breaks = c(1, 10000, 100000)) +
  facet_grid(cols = vars(location), labeller = as_labeller(facet_names)) +
  theme(panel.grid.minor = element_line(size=0)) +
  ylab("median AR length") +
  xlab("") +
  guides(fill = "none")
  
ggsave(file="manuscript/images/Fig_AR_len.png", plot=Fig_AR_len, width = 8, height=4, units = "in")
