...
For the sceme 2+3,there are 52 HR, 406 nonHR, 13 R and 50 NAs
...
N50 statistic comes only from Unicycler logs, that's why it is not avaialble for that many strains
...
`n.plasmids` does not behave well after transformation.
