...
Let's fit Poisson regression

```{r}
resistance_01 <- ifelse(data_strain$resistance == "HR", 1, 0)

poisson_fit_nbl <- glm(resistance_01 ~ data_strain$n.beta.lac, family = "poisson")
summary(poisson_fit_nbl)
```

```{r}
exp(coef(poisson_fit_nbl))
```
