...
ggsave(file="images/manuscript/Fig_8A_PCA.png", plot=Fig_8A, width = 8, height=4, units = "in")
...
Fig_8B <- kpcayj_recipe %>% 
  prep() %>% 
  juice() %>% 
  plot_validation_results(c("kPC1", "kPC2", "kPC3", "kPC4")) +
  ggtitle("Kernel Principal Component Analysis")

ggsave(file="images/manuscript/Fig_8B_kPCA.png", plot=Fig_8B, width = 8, height=4, units = "in")
...
Fig_8C <- umap_yj_recipe %>%
  prep() %>% 
  juice() %>% 
  plot_validation_results(c("UMAP01", "UMAP02", "UMAP03", "UMAP04")) +
  ggtitle("UMAP unsupervised")

ggsave(file="images/manuscript/Fig_8C_UMAPu.png", plot=Fig_8C, width = 8, height=4, units = "in")
...
Fig_8D <- umap_sup_yj_recipe %>%
  prep() %>% 
  juice() %>% 
  plot_validation_results(c("UMAP01", "UMAP02", "UMAP03", "UMAP04")) +
  ggtitle("UMAP supervised")

ggsave(file="images/manuscript/Fig_8D_UMAPs.png", plot=Fig_8D, width = 8, height=4, units = "in")
...
Fig_8 <- ggarrange(Fig_8A, Fig_8B, Fig_8C, Fig_8D,
                    labels = c("A", "B", "C", "D"),
                    ncol = 2, nrow = 2, common.legend = TRUE)

ggsave(file="images/manuscript/Fig_8_dimred_all.png", plot=Fig_8, width = 8, height=8, units = "in")
...
```{r}
Fig_4A <- ggplot(data_strain, aes(n.beta.lac.4)) +
  geom_bar(aes(fill = resistance), position = "fill") +
  scale_fill_brewer(palette="Set1") +
  xlab("n β-lactamases") +
...
ggsave(file="images/manuscript/n_BL_greater_4.png", plot=Fig_4A, width = 8, height=4, units = "in")
...
ggsave(file="images/manuscript/Fig_4B_plasmid_BL.png", plot=Fig_4B, width = 8, height=4, units = "in")
...
Fig_6A <- ggplot(bl_type_count_tidy, aes(gene, sum))+
...
ggsave(file="images/manuscript/Fig_6A_ampC.png", plot=Fig_6A, width = 8, height=4, units = "in")
...
Fig_6 <- ggarrange(Fig_6A + theme(legend.position = "bottom"), 
                   Fig_6B + theme(legend.position = "none"),
                   #empty_plot_with_legend,
                   ncol = 1, nrow = 2, labels = c("A", "B"))

ggsave(file="images/manuscript/Fig_6_TEM+ampC.png", plot=Fig_6, width = 8, height=8, units = "in")
...
```{r}
Fig_6B <- ggplot(data_strain, aes(TEM.beta.lactamase)) +
  geom_bar(aes(fill = resistance), position = "fill", alpha = 1) +
  scale_fill_brewer(palette = "Set1", name = "") +
  xlab("TEM β-lactamases") +
  ylab("proportion")

ggsave(file="images/manuscript/Fig_6B_TEM.png", plot=Fig_6B, width = 8, height=4, units = "in")
...
ggsave(file="images/manuscript/Fig_4_BL4+TEM.png", plot=Fig_4, width = 8, height=4, units = "in")
...
ggsave(file="images/manuscript/Fig_3B_coverage.png", plot=Fig_3B, width = 8, height=4, units = "in")
...
ggsave(file="images/manuscript/Fig_3A_longest_read.png", plot=Fig_3A, width = 8, height=4, units = "in")
...
Fig_3 <- ggarrange(Fig_3A, Fig_3B, 
          labels = c("A", "B"),
                    ncol = 1, nrow = 2)

ggsave(file="images/manuscript/Fig_3_coverage+length.png", plot=Fig_3, width = 8, height=8, units = "in")
...
ggsave(file="images/manuscript/Fig_5B_replen.png", plot=Fig_5B, width = 8, height=4, units = "in")
...
ggsave(file="images/manuscript/Fig_5A_repeats.png", plot=Fig_5A, width = 8, height=4, units = "in")
...
ggsave(file="images/manuscript/Fig_5C_AR.png", plot=Fig_5B, width = 8, height=4, units = "in")
...
```{r,fig.height=8, fig.width=6}
Fig_5 <- ggarrange(Fig_5A, Fig_5B, Fig_5C,
                    labels = c("A", "B", "C"),
                    ncol = 1, nrow = 3)

ggsave(file="images/manuscript/Fig_5_repeats+length+AR.png", plot=Fig_5, width = 8, height=10, units = "in")
...
ggsave(file="images/manuscript/Fig_7A_IS.png", plot=Fig_7A, width = 8, height=4, units = "in")
...
ggsave(file="images/manuscript/Fig_7D_IS-copies.png", plot=Fig_7D, width = 8, height=4, units = "in")
...
ggsave(file="images/manuscript/Fig_7C_IS-fam.png", plot=Fig_7C, width = 8, height=4, units = "in")
...
Fig_7B <- data_strain %>% 
  ...
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  scale_fill_brewer(palette = "Pastel1") +
  ylab("min distance, bp") +
  xlab("") +
  guides(fill="none")

ggsave(file="images/manuscript/Fig_7B_IS-dist.png", plot=Fig_7B, width = 8, height=4, units = "in")

Fig_7B
```

```{r,fig.height=8, fig.width=9}
Fig_7 <- ggarrange(Fig_7A, Fig_7B, Fig_7C, Fig_7D,
                    labels = c("A", "B", "C", "D"),
                    ncol = 2, nrow = 2)

ggsave(file="images/manuscript/Fig_7_IS-all.png", plot=Fig_7, width = 8, height=8, units = "in")
