...
```{r, eval=FALSE}
Fig_6C <-  ggplot(data_strain, aes(n.beta.lac.plus)) +
  geom_bar(aes(fill = resistance), position = "fill", alpha = 1) +
  scale_fill_brewer(palette = "Set1", name = "") +
  xlab("n beta-lactamases on plus strand") +
  ylab("proportion") 
...
Fig_6B <- ggplot(bl_type_count_tidy, aes(gene, sum))+
...
```{r}
Fig_4B <- ggplot(data_strain, aes(TEM.beta.lactamase)) +
  geom_bar(aes(fill = resistance), position = "fill", alpha = 1) +
  scale_fill_brewer(palette = "Set1", name = "") +
