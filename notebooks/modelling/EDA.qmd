...
10 PCs explain 70% of variation
18 PCs needed to explain 80% of variation 
30 PCs needed to explain 90% of variation
...
isomap_recipe <- 
  ...
  step_YeoJohnson(all_numeric_predictors())  %>%
  step_normalize(all_numeric_predictors()) %>% 
  step_isomap(all_numeric_predictors(), num_terms = 5, neighbors = 50) %>% 
  step_normalize(all_numeric_predictors())
