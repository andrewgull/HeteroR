...
ggsave(file="images/manuscript/Fig_5B_AR.png", plot=Fig_5B, width = 8, height=4, units = "in")
...
```{r,fig.height=8, fig.width=6}
Fig_5 <- ggarrange(Fig_5A, Fig_5B,
                    labels = c("A", "B"),
                    ncol = 1, nrow = 2)

ggsave(file="images/manuscript/Fig_5_repeats+AR.png", plot=Fig_5, width = 8, height=8, units = "in")
