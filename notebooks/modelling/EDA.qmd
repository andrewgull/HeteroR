...
Don't forget to use correct paths!

```{bash}
rsync HeteroR/results/tables/features.csv.gz ./data
rsync HeteroR/results/tables/features_strain.csv ./data
rsync HeteroR/results/tables/amr_types_strain.csv ./data
```
...
Fig_BL_total <- ggplot(data_strain, aes(n.beta.lac)) +
  ...
  scale_fill_brewer(palette = "Set1", name = "", labels=c("HR", "non-HR")) +
...
Fig_med_rep_len <- 
  ...
  scale_fill_brewer(palette = "Pastel1") +
  scale_x_discrete(labels=c("HR", "non-HR")) +
  coord_trans(y = "log") +
