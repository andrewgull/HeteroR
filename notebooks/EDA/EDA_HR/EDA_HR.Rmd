...
```{r, fig.width=6, fig.height=4}
bl_n_genes <- features_bl %>% select(strain, record_id) %>% distinct() %>% group_by(strain) %>% summarise(N=n())

ggplot(bl_n_genes, aes(N)) + 
...
```{r, fig.width=6, fig.height=4}
ggplot(features_bl_strain, aes(resistance, n.plasmids))+
...
```{r, fig.width=6, fig.height=4}
ggplot(features_bl_strain, aes(n.plasmids))+
  geom_bar(aes(fill=resistance), position="dodge", alpha=0.8)+
  scale_fill_brewer(palette="Set1")+
...
###########################################
plot.mrl.all <- ggplot(features_bl_strain%>% filter(med.rep.len > 0), aes(resistance, med.rep.len)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
...
plot.mrl.cen <- ggplot(features_bl_strain %>% filter(med.rep.len.cen > 0), aes(resistance, med.rep.len.cen)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = F, varwidth=T)+
...
plot.mrl.non.cen <- ggplot(features_bl_strain%>% filter(med.rep.len.non.cen > 0), aes(resistance, med.rep.len.non.cen)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = F, varwidth = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  coord_trans(y="sqrt") +
...
plot.mrl.all.100 <- ggplot(features_bl_strain, aes(resistance, med.rep.len.100)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = F, varwidth = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  scale_fill_brewer(palette = "Set1") +
...
plot.mrl.cen.100 <- ggplot(features_bl_strain, aes(resistance, med.rep.len.cen.100)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = F, varwidth=T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  scale_fill_brewer(palette = "Set1") +
...
plot.mrl.non.cen.100 <- ggplot(features_bl_strain, aes(resistance, med.rep.len.non.cen.100)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = F, varwidth = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  scale_fill_brewer(palette = "Set1") +
...
plot.maxrl.all <- ggplot(features_bl_strain %>% filter(max.rep.len > 0), aes(resistance, max.rep.len)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = F, varwidth = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  coord_trans(y="sqrt") +
...
plot.maxrl.cen <- ggplot(features_bl_strain %>% filter(max.rep.len.cen > 0), aes(resistance, max.rep.len.cen)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = F, varwidth = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  coord_trans(y="sqrt") +
...
plot.maxrl.non.cen <- ggplot(features_bl_strain %>% filter(max.rep.len.non.cen > 0), aes(resistance, max.rep.len.non.cen)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = F, varwidth = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  coord_trans(y="sqrt") +
...
```{r, fig.height=6, fig.width=14}
plot.rc.all <- ggplot(features_bl_strain %>% filter(n.rep.total > 0), aes(resistance, n.rep.total)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
...
plot.rc.cen <- ggplot(features_bl_strain %>% filter(n.rep.tot.cen > 0), aes(resistance, n.rep.tot.cen)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = T, varwidth = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  coord_trans(y="sqrt") +
...
plot.rc.non.cen <- ggplot(features_bl_strain %>% filter(n.rep.tot.cen > 0), aes(resistance, n.rep.tot.non.cen)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = T, varwidth = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  coord_trans(y="sqrt") +
...
plot.arl.all <- ggplot(features_bl_strain %>% filter(med.AR.len > 0), aes(resistance, med.AR.len)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = T, varwidth = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  coord_trans(y="sqrt") +
...
plot.arl.cen <- ggplot(features_bl_strain %>% filter(med.AR.len.cen > 0), aes(resistance, med.AR.len.cen)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = T, varwidth = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  coord_trans(y="sqrt") +
...
plot.arl.non.cen <- ggplot(features_bl_strain%>% filter(med.AR.len.non.cen > 0), aes(resistance, med.AR.len.non.cen)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = T, varwidth = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  coord_trans(y="sqrt") +
...
```{r, fig.height=6, fig.width=14}
plot.arl.100 <- ggplot(features_bl_strain %>% filter(med.AR.len.100 > 0), aes(resistance, med.AR.len.100)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = F, varwidth = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  coord_trans(y="sqrt") +
...
plot.arl.cen.100 <- ggplot(features_bl_strain %>% filter(med.AR.len.cen.100 > 0), aes(resistance, med.AR.len.cen.100)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = F, varwidth = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  coord_trans(y="sqrt") +
...
plot.arl.non.cen.100 <- ggplot(features_bl_strain %>% filter(med.AR.len.non.cen.100 > 0), aes(resistance, med.AR.len.non.cen.100)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = F, varwidth = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  coord_trans(y="sqrt") +
