...
join_RGI_repeatCounts <- function(rg.ab.found.df, rgi.results, repeat.counts){
...
count_per_ab <- join_RGI_repeatCounts(rg_ab_found_df, rg_df_notLoose, repeat_counts_gene_sample)
count_per_ab
```
