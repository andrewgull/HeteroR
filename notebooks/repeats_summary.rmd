...
Columns with *SIR* contain susceptibility test results, S - susceptible, R - resistant.

---

CFX - Cefotaxime

TZP - ?, look in the newer version of the table
...
ggplot(resistance_df_td, aes(strain, AB)) + 
...
```{r, fig.width=8}
ggplot(res_df_sample, aes(strain, AB)) + 
  geom_tile(aes(fill=condition)) +
