...
plot.mrl.cen <- ggplot(features_amp_strain, aes(resistance, med.rep.len.cen)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = F, varwidth=T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  scale_fill_brewer(palette = "Set2") +
...
plot.mrl.all.100 <- ggplot(features_amp_strain, aes(resistance, med.rep.len.100)) + 
  ...
  scale_fill_brewer(palette = "Set2") +
  xlab("")+ylab("length, bp") +
  ggtitle(label="Median repeat length", subtitle = "minimum 100")+
  guides(fill="none")
...
plot.mrl.cen.100 <- ggplot(features_amp_strain, aes(resistance, med.rep.len.cen.100)) + 
  ...
  scale_fill_brewer(palette = "Set2") +
  xlab("")+ ylab("length, bp")+
  ggtitle("", subtitle = "repeats spanning center, min 100")+
  guides(fill="none")
...
plot.mrl.non.cen.100 <- ggplot(features_amp_strain, aes(resistance, med.rep.len.non.cen.100)) + 
  ...
  scale_fill_brewer(palette = "Set2") +
  xlab("")+ ylab("length, bp")+
  ggtitle("", subtitle = "repeats not spanning center, min 100")+
  guides(fill="none")

##########################################
ggarrange(plot.mrl.all, plot.mrl.cen, plot.mrl.non.cen, plot.mrl.all.100, plot.mrl.cen.100, plot.mrl.non.cen.100,
          ncol=3, nrow=2, 
...
plot.rc.s.all.amp <- ggplot(features_amp_strain, aes(resistance, n.rep.total)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
...
plot.rc.s.100.amp <- ggplot(features_amp_strain, aes(resistance, n.rep.tot.cen)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  coord_trans(y="sqrt") +
  scale_fill_brewer(palette = "Set2") +
  xlab("")+ylab("")+
  ggtitle("Repeat count, spanning center")

plot.rc.s.100.amp <- ggplot(features_amp_strain, aes(resistance, n.rep.tot.non.cen)) + 
  geom_violin(aes(fill=resistance), alpha=0.7)+
  geom_boxplot(aes(fill=resistance), alpha=0.2, notch = T)+
  geom_jitter(alpha=0.2, width=0.15, height = 0.1)+
  coord_trans(y="sqrt") +
  scale_fill_brewer(palette = "Set2") +
  xlab("")+ylab("")+
  ggtitle("Repeat count, not spanning center")
