...
## Add ampC counts to features_amp_strain

```{r}
features_amp_strain <- left_join(features_amp_strain, select(amp_amr_types_strain, strain, ampC), by = "strain") %>%  relocate(ampC, .before = "n.rep.total") %>% rename("n.ampC" = ampC)
```
