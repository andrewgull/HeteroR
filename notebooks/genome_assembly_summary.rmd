...
I was unable to find plasmid in 20 strains
...
```{r, warning = FALSE, message = FALSE, fig.width = 8, fig.asp = 0.6}
...
```{r}
ggplot(plasmids_count, aes(Count)) + geom_histogram(stat="bin", bins = 12)
```
...
plot_length_chrom <- ggplot(summary_chrom, aes(Length)) +
