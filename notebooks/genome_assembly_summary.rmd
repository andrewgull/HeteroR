...
```{r, fig.width=9, fig.height=4}
ggplot(summary_table %>% filter(Status2 != "additional_plasmid"), aes(Status2, N50)) +
  geom_boxplot(aes(fill=Type), notch=T, varwidth = T) +
  scale_fill_brewer(palette = "Set2")

```

## Numbers of assemblies with incomplete chromosomes

To assemble with Trycycler
