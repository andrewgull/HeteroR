...
and functional annotation of selected genes
...
```{r}
# to find organism name
# availablePthOrganisms(PANTHER.db) %>% 
#   dplyr::filter(`PANTHER Species` == "ECOLI")

# set your organism of interest
pthOrganisms(PANTHER.db) <- "ECOLI"
PANTHER.db
```
...
# ise_lengths$IS91
# 'cluster' is in the fasta headers
...
write_delim(best_is_representatives, "/home/andrei/Data/HeteroR/results/mutants/ismapper/is_representatives.tsv", delim = "\t")
