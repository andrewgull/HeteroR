...
dir_path <- "/home/andrei/Data/HeteroR/results/assemblies_joined/"

assembly_summaries <- map_dfr(parents, ~ read_tsv(paste0(dir_path, ., "/summary.tsv"), 
                                                  show_col_types = F, 
                                                  col_types = "ccdccc",
                                                  col_select = c("Component", "Length", "Coverage", "Status", "Type", "Strain")))
# "Component", "Length", "Coverage", "Status", "Type", "Strain"
assembly_summaries
```
