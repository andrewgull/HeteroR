...
dir_path <- "/home/andrei/Data/HeteroR/results/genome_coverage/"

test_depth <- paste0(dir_path, parents[1], "/depth.txt")
...
mut_depth_df <- read_tsv("/home/andrei/Data/HeteroR/results/variants/DA62886/mutant_depth.tsv", col_names = F, show_col_types = F)
...
mut <- parse_depth("/home/andrei/Data/HeteroR/results/variants/DA62886/mutant_depth.tsv", strain = "DA62886", label = "mutant")
...
```{r}
relative_coverage_files <- dir("/home/andrei/Data/HeteroR/results/copy_number/", pattern = "*tsv", recursive = T)
