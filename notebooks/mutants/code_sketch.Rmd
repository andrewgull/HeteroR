...
```{r}
parse_depth <- function(file_path, min_contig_length=1000) {
  depth_df <- read_tsv(file_path, col_names = F, show_col_types = F)
  
  # check correct column names
  stopifnot(exprs = {"X8" %in% names(depth_df) & "X3" %in% names(depth_df)})
...
parse_depth("/home/andrei/Data/HeteroR/results/variants/DA62886/mutant_depth.tsv")
