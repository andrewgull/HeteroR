...
bamFile <- BamFile("/home/andrei/Data/HeteroR/results/variants/DA63752/mutant_mapped.bam")

# Count all reads
allReads <- scanBam(bamFile, param = ScanBamParam(what = "flag"))

# Count unmapped reads
unmappedReads <- scanBam(bamFile, param = ScanBamParam(what = "flag", flag = scanBamFlag(isUnmappedQuery = TRUE)))

# Calculate the number of reads
totalReads <- length(allReads[[1]]$flag)
totalUnmappedReads <- length(unmappedReads[[1]]$flag)

# Calculate mapped reads
totalMappedReads <- totalReads - totalUnmappedReads

# Print statistics
totalUnmappedReads/totalReads
