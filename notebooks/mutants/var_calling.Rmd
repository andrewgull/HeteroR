...
depth <- fread("/home/andrei/Data/HeteroR/results/variants/DA62886/depth.tsv.gz", sep = "\t")
...
depth_per_window <- 
  ...
  mutate(rel_cov = coverage / mean_coverage)

depth_per_window %>% 
  ggplot(aes(window, coverage)) +
  geom_point(size=0.2) +
...
### Automated search for over-covered regions
